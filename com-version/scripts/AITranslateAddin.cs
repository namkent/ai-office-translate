...
namespace AITranslateAddin
{
    // Lớp cơ sở xử lý chung cho Word, Excel, PowerPoint
    [ComVisible(true)]
    [ClassInterface(ClassInterfaceType.AutoDual)]
    public class BaseAddin : IDTExtensibility2, IRibbonExtensibility
    {
        ...
        // Dịch và ghi đè nội dung ô Excel
    ...
    // Excel Addin class
    [ComVisible(true)]
    [Guid("8A16298B-77E5-46D9-B582-7EF2C3F6F6B1")]
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("AITranslate.Excel")]
    public class ExcelAddin : BaseAddin, IDTExtensibility2, IRibbonExtensibility
    {
        public ExcelAddin() { this.hostType = "Excel"; }
    }

    // Word Addin class
    [ComVisible(true)]
    [Guid("8A16298B-77E5-46D9-B582-7EF2C3F6F6B2")]
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("AITranslate.Word")]
    public class WordAddin : BaseAddin, IDTExtensibility2, IRibbonExtensibility
    {
        public WordAddin() { this.hostType = "Word"; }
    }

    // PowerPoint Addin class
    [ComVisible(true)]
    [Guid("8A16298B-77E5-46D9-B582-7EF2C3F6F6B3")]
    [ClassInterface(ClassInterfaceType.AutoDual)]
    [ProgId("AITranslate.PPT")]
    public class PowerPointAddin : BaseAddin, IDTExtensibility2, IRibbonExtensibility
    {
        public PowerPointAddin() { this.hostType = "PPT"; }
    }
